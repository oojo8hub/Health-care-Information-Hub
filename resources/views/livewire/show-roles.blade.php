        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            ...
            <div class="flex items-center justify-between pb-4 mt-4">
                <div class="pb-4 bg-white ">
                    ...
                    <div class="relative mt-1">
                        ...
                        <input type="text" id="table-search" wire:model="search" class="inline-block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500      " placeholder="Search for roles">
                    </div>
                </div>
            ...
            @if (session()->has('role-deleted'))
                <div
                    ...
                    <div>
                        <span class="font-medium">{{ session('role-deleted') }}</span>
                    </div>
                </div>
            @endif
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
                <table class="w-full text-sm text-left text-gray-500 ">
                    ...
                    @foreach ($roles as $role)
                        <tr wire:key="item-{{ $role->id }}" class="bg-white border-b   hover:bg-gray-50 ">
                            ...
                            <td class="flex px-6 py-4 space-x-4">
                                ...
                                @can('delete roles')
                                    @if($confirmingId == $role->id)
                                        <span wire:click="cancelDelete('{{ $role->id }}')" class="hover:cursor-pointer">
                                        ...
                                        <span wire:click="deleteRole('{{ $role->id }}')" class="hover:cursor-pointer">
                                    ...
                                    @elseif(!$role->system_default)
                                        <span wire:click="doSomething('{{ $role->id}}')" class="hover:cursor-pointer">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">

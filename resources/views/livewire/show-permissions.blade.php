        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            ...
            <div class="flex items-center justify-between pb-4 mt-4">
                <div class="pb-4 bg-white ">
                    ...
                    <div class="relative mt-1">
                        ...
                        <input type="text" id="table-search" wire:model="search" class="inline-block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500      " placeholder="Search for permissions">
                    </div>
                </div>
            ...
            @if (session()->has('permission-deleted'))
                <div
                    ...
                    <div>
                        <span class="font-medium">{{ session('permission-deleted') }}</span>
                    </div>
                </div>
            @endif
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
                <table class="w-full text-sm text-left text-gray-500 ">
                    ...
                    @foreach ($permissions as $permission)
                        <tr wire:key="item-{{ $permission->id }}" class="bg-white border-b   hover:bg-gray-50 ">

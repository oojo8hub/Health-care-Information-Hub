        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            ...
            <div class="flex items-center justify-between pb-4 mt-4">
                <div class="pb-4 bg-white ">
                    ...
                    <div class="relative mt-1">
                        ...
                        <input type="text" id="table-search" wire:model="search" class="inline-block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500      " placeholder="Search for users">
                    </div>
                </div>
            </div>
            ...
            @if (session()->has('user-deleted'))
                <div
                    ...
                    class="flex p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50   " role="alert">
                    <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <div>
                        <span class="font-medium">{{ session('user-deleted') }}</span>
                    </div>
                </div>
            @endif
                ...
                <table class="w-full text-sm text-left text-gray-500 ">
                            ...
                            <th scope="col" class="px-6 py-3">
                                <div class="flex space-x-1 items-center">
                                    ...
                                    <a wire:click="sortBy('first_name')">
                                       <span>
                                            @if ($sortDirection === 'asc' && $sortColumn === 'first_name')
                                           ...
                                           @elseif ($sortDirection === 'desc' && $sortColumn === 'first_name')
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr wire:key="item-{{ $user->id }}" class="bg-white border-b   hover:bg-gray-50 ">
                                ...
                                <td class="flex px-6 py-4 space-x-4">
                                    ...
                                    @can('delete users')
                                        @if($confirmingId == $user->id)
                                            <span wire:click="cancelDelete('{{ $user->id }}')" class="hover:cursor-pointer">
                                            ...
                                            <span wire:click="deleteUser('{{ $user->id }}')" class="hover:cursor-pointer">
                                        ...
                                        @elseif(!$user->hasRole('super admin'))
                                            <span wire:click="doSomething('{{ $user->id}}')" class="hover:cursor-pointer">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
